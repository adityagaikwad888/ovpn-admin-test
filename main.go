...
var (
	...
	// clientCertExpirationDays = kingpin.Flag("client-cert.expiration-days", "Expiration period of OpenVPN client certificates in days, the period will shrink automatically to the CA expiration period").Default("365").Envar("CLIENT_CERT_EXPIRATION_DAYS").String()
	// serverCertExpirationDays = kingpin.Flag("server-cert.expiration-days", "Expiration period of OpenVPN server certificate in days, will shrink to CA expiration if needed").Default("365").Envar("SERVER_CERT_EXPIRATION_DAYS").String()
